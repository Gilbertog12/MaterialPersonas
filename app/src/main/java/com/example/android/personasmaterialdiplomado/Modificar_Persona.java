...
public class Modificar_Persona extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar__persona);
    ...
    public void editar(View v){
        if (validarm()){
            Persona p = new Persona(foto, txtCedulam.getText().toString(), txtNombrem.getText().toString(), txtApellidom.getText().toString(),sexom.getSelectedItemPosition());
            p.editar();
